...
public class SketchLaunchControlXL extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main(new String[]{"SketchLaunchControlXL",});
    }
    ...
    void drawKnobs() {
        ...
        for (int i = 0; i < 24; i++) {
            ...
            if (i == 7) translate(0, height * .16f);
            if (i == 15) translate(0, height * .16f);
        }
    }
